...
/**
 * Report for event names containing a specific action
 */
class GetEventNamesForAction extends Report
{
    protected function init()
    {
        ...
        $this->action = 'getEventNamesForAction';
        $this->name = Piwik::translate('Events_EventNames');
        $this->documentation = Piwik::translate('EventsEnhanced_EventNamesForActionDocumentation');
