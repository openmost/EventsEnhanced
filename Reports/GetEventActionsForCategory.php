...
/**
 * Report for event actions within a specific category
 */
class GetEventActionsForCategory extends Report
{
    protected function init()
    {
        ...
        $this->action = 'getEventActionsForCategory';
        $this->name = Piwik::translate('Events_EventActions');
        $this->documentation = Piwik::translate('EventsEnhanced_EventActionsForCategoryDocumentation');
