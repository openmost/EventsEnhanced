...
/**
 * Report for event categories containing a specific action
 */
class GetEventCategoriesForAction extends Report
{
    protected function init()
    {
        ...
        $this->action = 'getEventCategoriesForAction';
        $this->name = Piwik::translate('Events_EventCategories');
        $this->documentation = Piwik::translate('EventsEnhanced_EventCategoriesForActionDocumentation');
        ...
        $this->parameters = [
            'eventAction' => Common::getRequestVar('eventAction', '', 'string'),
        ];
    }
