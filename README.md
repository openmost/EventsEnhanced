...
1. Navigate to the Events reports in Matomo (Behavior > Events)
2. In any events data table (Categories, Actions, or Names), hover over a row
3. Click the "View Event Details" icon that appears
4. Explore the detailed analytics for that specific event dimension value

## Requirements

- Matomo 5.6.0 or later
